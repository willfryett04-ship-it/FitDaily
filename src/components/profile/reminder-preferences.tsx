    ...
    try {
      if (Capacitor.isNativePlatform()) {
        if (enabled) {
          ...
          await LocalNotifications.schedule({ notifications: [{ id: notificationId, title: "Fit Daily", body: "Your outfit suggestion is ready.", schedule: { on: { hour, minute }, repeats: true } }] });
