  ...
  return (
    <main className="min-h-screen bg-[#f8f7f4] px-6 py-8 text-[#201d1a] sm:px-10">
      <header className="mx-auto flex max-w-5xl items-center justify-between">
        ...
        <div className="flex items-center gap-2"><Button asChild variant="outline" className="rounded-xl"><a href="/planner">Planner</a></Button><Button asChild variant="outline" className="rounded-xl"><a href="/profile">Profile</a></Button><SignOutButton /></div>
      </header>
